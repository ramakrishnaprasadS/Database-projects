...
--to add ticket id and also traveller_id as foreign key....
...
ALTER TABLE TRAVELLER_TICKET ADD CONSTRAINT TRVLR_ID_FK FOREIGN KEY(TRAVELLER_ID) REFERENCES TRAVELLER(ID);
